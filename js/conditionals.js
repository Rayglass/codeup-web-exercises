...
// var colors = ['red', 'orange', 'yellow', 'green', 'blue', 'indigo', 'violet'];
// var colorInput = colors[Math.floor(Math.random() * colors.length)];
...
function analyzeColors() {
    switch (colorInput) {
        ...
        default:
            return (
                colorInput + " is undefined, I will have to get back to you on that!"
            );
            break;
    }
}
...
console.log(analyzeColors(colorInput));
